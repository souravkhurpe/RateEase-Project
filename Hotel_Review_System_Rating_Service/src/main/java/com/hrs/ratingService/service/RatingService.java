...
public interface RatingService {
	...
	List<RatingResponseDTO> getRatingByUserId(Integer userId);

	List<RatingResponseDTO> getRatingByHotelId(Integer hotelId);

	void deleteRatingByRatingId(Integer ratingId);
